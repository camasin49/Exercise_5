                            ...
                            <div className="relative flex flex-col mb-2">
                                ...
                                focus:outline-none text-white font-bold py-2 px-3 rounded w-full" type="button" onClick={login}>
                                    ...
                                    <div className="mt-5 content-center text-center">
                                        <h3 className="text-center font-medium text-sm text-gray-100">Don't have an account? <span className="text-blue-500 cursor-pointer" onClick={register}>Sign Up</span></h3>
                                    </div>
                                </div>
                            </div>
